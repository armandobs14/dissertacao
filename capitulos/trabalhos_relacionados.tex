...
Diferentemente das ferramentas citadas, a proposta utiliza ontologias para guiar o processo de correspondência de instância. Além disso, essa abordagem permite que o usuário defina como o alinhamento deve ser realizado. A tabela \ref{tab:comparacao} sumariza e compara os trabalhos relacionados com a proposta.
...
\begin{tabular}{@{}clcl}
	\toprule
	Ferramenta & Múltiplos \textit{datasets} & Suporte à ontologia & Suporte à transitividade \\ \midrule
	   AML     & 2                           &      Dirigido       &  \\
	  RiMOM    & 2                           &      Dirigido       &  \\
	 Proposta  & 2 ou mais                   &       Baseado       & X                        \\ \midrule
\end{tabular}
\end{table}
