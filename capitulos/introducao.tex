...
% * <profsean@gmail.com> 2017-01-18T15:50:06.195Z:
% 
% > Web de dados
% Incluir nota de rodapé: Para mais informações, acesse: https://www.w3.org/standards/semanticweb/data
% 
% ^.
...
% * <profsean@gmail.com> 2017-01-18T16:01:26.668Z:
% 
% > serialização RDF
% Deveria ter explicado... Sugiro acrescentar explicação em nota de rodapé...
% 
% ^.
% * <profsean@gmail.com> 2017-01-18T15:56:09.697Z:
% 
% > Consequentemente, a utilização de Dados Conectados vem sendo realizada de forma crescente.
% Cadê evidências disto? Por que isto é importante aqui no seu texto? Sugiro retirar esta frase.
% 
% ^.
% * <profsean@gmail.com> 2017-01-18T15:55:48.722Z:
% 
% > permitindo que os dados possam ser conectados a outros, mesmo estando em bases diferentes
% Mas não é esta a ideia de dados conectados? Então, o que se ganhou com isto?
% 
% ^.
% * <profsean@gmail.com> 2017-01-18T15:55:04.798Z:
% 
% > Gmail
% E o que ganhou com isto?
% 
% ^.
% * <profsean@gmail.com> 2017-01-18T15:54:34.908Z:
% 
% > json-ld
% Acrescentar breve explicação e link em nota de rodapé...
% 
% ^.
% * <profsean@gmail.com> 2017-01-18T15:54:26.188Z:
% 
% > RDFa
% Acrescentar breve explicação e link em nota de rodapé...
% 
...
% * <profsean@gmail.com> 2017-01-18T16:12:01.753Z:
% 
% > baseadas em recursos
% não seriam orientadas a instância?
% 
% ^.

\textbf{Baseada em aprendizagem:} utiliza grupos de treinamento bem como técnicas de aprendizagem de máquina, como Máquina de Vetor de Suporte, para definir se os recursos representam a mesma entidade do mundo real.
...
\textbf{Baseadas em regras:} Diferente das outras técnicas, esta usa valores boleanos no lugar de valores numéricos. Além disso, esta subcategoria apresenta bons resultados, porém esta abordagem é dependente do domínio. 
