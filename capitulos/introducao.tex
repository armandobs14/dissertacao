...
Porém, de acordo com \citeonline{homoceanu2014putting}, apesar dos bons resultados apresentados, as soluções avaliadas não estão prontas para alinhar dados automaticamente de forma confiável. Para tal argumentação, eles realizaram um experimento similar ao utilizado pela OAEI, porém com dados reais. Além disso, outro fator que foi considerado está no fato de não considerarem a trasitividade das prorpriedades semânticas, dentre essas a owl:sameAs.
